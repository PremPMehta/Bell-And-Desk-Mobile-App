...
type DirectMessageChatMessageItemProps = {
  item: any;
  nextMessage?: any;
  currentUser: any;
...
const DirectMessageChatMessageItem = ({
  item,
  nextMessage,
  currentUser,
  selectedMessageId,
  ...
  onPressReactions,
  openImageViewer,
}: DirectMessageChatMessageItemProps) => {
...
export default React.memo(DirectMessageChatMessageItem);
