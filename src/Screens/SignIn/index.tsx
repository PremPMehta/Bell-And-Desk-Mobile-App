      ...
      >
        ...
        >
          <View style={styles.middileViewStyle}>
            ...
            <Formik
              initialValues={{
                email: 'maddy@mailinator.com', //  admin@cryptomanji.com   baqy@mailinator.com  anthony@yopmail.com  maddy@mailinator.com
                password: 'Pa$$w0rd!', //  Password@123   Pa$$w0rd!  Pa$$w0rd!
              }}
